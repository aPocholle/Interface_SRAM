...
HD_PWD='F:/vivado_proj/Interface_SRAM/TP/TP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Interface.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Interface.tcl
